    ...
    <form onSubmit={handleSubmit}> {/* ✅ Corrected onSubmit */}
      <div className="flex flex-col justify-center items-center min-h-screen bg-gradient-to-br from-blue-400 to-purple-600 p-4">
        <div className="bg-white p-8 rounded-2xl shadow-lg w-full max-w-md flex flex-col items-center">
          <h1 className="text-3xl text-blue-600 font-extrabold p-4">Login here</h1>
          <p className="text-xl text-blue-600 pb-4">Welcome back! You've been missed!</p>
          ...
          <div className="flex flex-col gap-4 w-full">
            ...
            <input
              ...
              required
            />
            <button type="submit" className="bg-blue-500 text-white font-semibold py-2 rounded-lg cursor-pointer hover:bg-blue-600 transition-all w-full">
              Sign In
            </button>
          </div>
          ...
          <span className="mt-4 text-gray-600 text-center">
            ...
            <button className="text-blue-500 hover:underline ml-1 cursor-pointer" onClick={() => navigate("/signup")}>
              Sign Up
            </button>
          </span>
        </div>
